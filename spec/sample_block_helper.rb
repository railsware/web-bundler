class SampleBlockHelper
  ...
  def sample_cond_block
    "<!-- [if IE 7] >" +
    construct_links_block(@styles, @scripts) +
    sample_inline_block +
    "<! [endif] -->"
  end
  ...
  def sample_block_data
    data = BlockData.new
    data.css = ResourceBundle::Data.new(ResourceBundle::CSS, @styles)
    data.js = ResourceBundle::Data.new(ResourceBundle::JS, @scripts)
